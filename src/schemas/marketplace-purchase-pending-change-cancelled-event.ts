/**
 * Auto-generated Zod schema for MarketplacePurchasePendingChangeCancelledEvent
 * DO NOT MODIFY - regenerate with: bun run generate:schemas
 */

import type { MarketplacePurchasePendingChangeCancelledEvent as MarketplacePurchasePendingChangeCancelledEventOctokit } from '@octokit/webhooks-types';
import { z } from 'zod';

import { MarketplacePurchaseSchema } from './shared/index.js';

export const MarketplacePurchasePendingChangeCancelledEventSchema = z.object({
...
}) satisfies z.ZodType<MarketplacePurchasePendingChangeCancelledEventOctokit>;

export type MarketplacePurchasePendingChangeCancelledEvent =
  MarketplacePurchasePendingChangeCancelledEventOctokit;
