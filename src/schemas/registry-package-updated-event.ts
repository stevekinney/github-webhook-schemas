/**
 * Auto-generated Zod schema for RegistryPackageUpdatedEvent
 * DO NOT MODIFY - regenerate with: bun run generate:schemas
 */

import type { RegistryPackageUpdatedEvent as RegistryPackageUpdatedEventOctokit } from '@octokit/webhooks-types';
import { z } from 'zod';
...
export const RegistryPackageUpdatedEventSchema = z.object({
...
}) satisfies z.ZodType<RegistryPackageUpdatedEventOctokit>;

export type RegistryPackageUpdatedEvent = RegistryPackageUpdatedEventOctokit;

export function isRegistryPackageUpdatedEvent(
  value: unknown,
): value is z.input<typeof RegistryPackageUpdatedEventSchema> {
  return RegistryPackageUpdatedEventSchema.safeParse(value).success;
}
